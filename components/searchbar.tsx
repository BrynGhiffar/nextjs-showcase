...
export default function Search ({ set_project_data, page, projects_per_page, set_loading, search_term, set_search_term }: SearchProps){

  async function handleSearchClick() {
    set_loading(true);
    const res = await find_project_by_name(search_term, page, projects_per_page);
